...
export function applySearchFilters(data, keywords, filterProps) {
...
export function applyExtractOptions(data,prop, filterProp, filterValue) {
...
export function applyPaginatedData(data, currentPage, pageSize) {
